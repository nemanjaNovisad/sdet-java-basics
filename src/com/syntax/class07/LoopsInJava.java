...
public class LoopsInJava {
	...
	public static void main(String[] args) {
		...
		// Statement that executes a block of code n number of times based on a
		// condition
		...
		/*
		 * while (time<12) { System.out.println("Morning"); This is infinite loop }
		 */
		...
		// The code is repeated until the condition is true, then goes back and checks
		// the condition again
